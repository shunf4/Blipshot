// Copyright: https://github.com/FlameWolf/jsCrop FlameWolf GPL-3.0
// modified by shunf4
			...
			if(!currentInstance) {
				...
				let cropper = {
					...
					"drawCroppedImage": function() {
						...
						let finalWidth = this.gridHolderWidth * this.imageNaturalWidth / this.imageToCrop.offsetWidth;
						let finalHeight = this.gridHolderHeight * this.imageNaturalHeight / this.imageToCrop.offsetHeight;
						...
						this.cropResult.width = finalWidth;
						this.cropResult.height = finalHeight;
						...
						this.cropResultContext.clearRect(0, 0, finalWidth, finalHeight);
						...
						this.cropResultContext.drawImage(this.imageToCrop,
							...
							this.gridHolderLeft * this.imageNaturalWidth / this.imageToCrop.offsetWidth, this.gridHolderTop * this.imageNaturalHeight / this.imageToCrop.offsetHeight,
					...
					"initialiseGrid": function() {
						...
						this.imageNaturalWidth = this.imageToCrop.naturalWidth;
						this.imageNaturalHeight = this.imageToCrop.naturalHeight;
